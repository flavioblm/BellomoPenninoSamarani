...
\end{figure}
Additionally, it is useful to provide a more in-depth description of a generic microservice component. It is based on the \textbf{Controller-Service-Repository pattern}, which adds modularity and promotes separation of concerns within the component. This three sub-components operate as follow:
\begin{itemize}
