...
The design covers the system’s four-tier architecture, detailing the presentation, web server, application logic and data layers, as well as the interactions between them that ensure modularity, scalability and distribution. 
